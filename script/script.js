...
let menuItems,
    ...
    validUser = {user: "eduardguere", pass: "eguere1234"},
...
function updateOrder(clean) {
    ...
    order = [];
    form.innerHTML = '<input type="hidden" name="_next" value="https://eduardguere.github.io/ch-javascript/"><input type="hidden" name="_captcha" value="false">'; 
